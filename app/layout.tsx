...
export const metadata: Metadata = {
  ...
  description:
    "Monitor your business performance with real-time KPIs, revenue trends, and user analytics — all in one beautiful dashboard.",
  keywords: ["analytics", "dashboard", "SaaS", "metrics", "KPI"],
  authors: [{ name: "Pulse Analytics" }],
  openGraph: {
    title: "Pulse Analytics — SaaS Dashboard",
    description: "Monitor your business performance with real-time KPIs.",
    type: "website",
  },
};
